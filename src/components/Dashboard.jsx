    ...
    <div className=" min-h-screen">
      <div className="p-8">
        <div className="flex gap-[300px]">
          ...
          <h2 className="text-[50px] font-bold underline">
            Nivel: {user?.level_id.name}
          </h2>
        </div>
        ...
        <div className="flex space-x-4 mt-[50px]">
          ...
          <div className=" w-[800px] h-[400px] flex">
            <img src={funval} alt="logo funval" className="border  w-[400px] h-[200px] rounded-3xl"/>
            
          </div>
          <div className=" w-[800px] h-[400px] flex items-center">
            
            <img src={bandera} alt="logo funval" className="border h-[200px] rounded-3xl"/>
          </div>
        </div>
      </div>
    </div>
